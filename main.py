...
@app.route('/')
def home():
    return "E2EE Automation Server is running! Use the Streamlit app for the interface."
...
def setup_browser(automation_state=None):
    ...
    try:
        ...
        if driver_path:
            ...
            # Try without specifying driver path for Render
        ...
        # Try alternative approach for Render
        try:
            from selenium import webdriver
            ...
            log_message(f'Fallback browser setup also failed: {fallback_error}', automation_state)
            raise error
